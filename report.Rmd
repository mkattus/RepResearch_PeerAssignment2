...
Finally, I matched the event types input into the database (in column EVTYPE) with those provided in the documentation. I used the "amatch" function from the "stringdist" package to accomplish this. I experimented with several matching methods and maximum distances, and lanaded on the 'soundex' method as the most effective. The soundex method compares two strings based on phonetics. I mapped events recorded in the database to those from the official list if they were phonetically identical, otherwise NA was produced. This resulted in only 1795 NAs out of 201,318 recorded events. (As "TSTM" was a common abbreviation for thunderstorm, I made this substitution before running amatch.)
